...
export function RoomClosedOverlay({
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[200] flex flex-col items-center justify-center gap-6 bg-foreground/85 p-6 text-center backdrop-blur-md"
    >
      <motion.div
      ...
      <div className="flex flex-col gap-2">
        <h1
          ...
          className="font-display text-2xl font-extrabold uppercase tracking-wider text-background sm:text-3xl"
        >
          Partie fermée par l&apos;hôte
        </h1>
        <p className="max-w-sm text-base text-background/80">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="text-sm font-semibold text-background/70">
          Redirection automatique dans <span className="text-gold">{remaining}</span>s
        </p>
      </div>
    </motion.div>
  );
